...
REQUIRED_PROJECT_FILES = [
    ...
    "app/managed_cv/__init__.py",
    "app/managed_cv/models.py",
    "app/managed_cv/schema.py",
    "app/managed_cv/repository.py",
    "app/managed_cv/service.py",
    "app/managed_cv/editor_service.py",
    "app/managed_cv/form_models.py",
    "app/import_tools/__init__.py",
    "app/import_tools/models.py",
    "app/import_tools/cv_import.py",
    "app/import_tools/fact_import.py",
    "app/import_tools/service.py",
    "app/api/routes_import.py",
    "app/api/routes_cv_editor.py",
    "app/web/templates/profiles_import.html",
    "app/web/templates/cv_editor_index.html",
    "app/web/templates/cv_variant_detail.html",
    "app/web/templates/cv_block_edit.html",
    "app/web/templates/facts.html",
    "app/web/templates/fact_form.html",
    "tests/unit/import_tools/test_import_tools.py",
    "tests/integration/routes/test_import_routes.py",
    "tests/unit/managed_cv/test_managed_cv_storage.py",
    "tests/unit/managed_cv/test_cv_editor_service.py",
    "tests/integration/routes/test_cv_editor_routes.py",
    "app/secrets/__init__.py",
    "app/secrets/openai_key.py",
    "tests/unit/secrets/test_openai_secret_service.py",
    "tests/unit/llm/test_llm_factory.py",
    "tests/unit/settings/test_app_settings_storage.py",
    "tests/unit/settings/test_app_settings_config_overlay.py",
    "app/web/__init__.py",
    "app/web/routes.py",
    ...
    "tests/integration/routes/test_health_routes.py",
    "tests/integration/routes/test_application_routes.py",
    "tests/integration/routes/test_review_routes.py",
    "tests/integration/routes/test_dashboard_routes.py",
    "tests/unit/core/test_paths.py",
    "tests/unit/storage/test_app_dirs.py",
    "tests/unit/storage/test_storage_bootstrap.py",
    "tests/unit/setup/test_setup_checks.py",
    "tests/integration/routes/test_setup_routes.py",
    "tests/integration/routes/test_settings_routes.py",
    "tests/integration/routes/test_data_folder_routes.py",
    "tests/unit/profiles/test_managed_profiles_storage.py",
    "tests/integration/routes/test_profiles_routes.py",
    "app/db/__init__.py",
    "app/db/base.py",
    "app/db/models.py",
    "app/db/repositories.py",
    "app/db/session.py",
    "tests/unit/db/test_db_models.py",
    ...
    "tests/unit/db/test_alembic_setup.py",
    "app/jobs/__init__.py",
    "app/jobs/hashing.py",
    "app/jobs/input_models.py",
    "app/jobs/normalisation.py",
    "app/jobs/service.py",
    "tests/unit/jobs/test_job_hashing.py",
    "tests/unit/jobs/test_job_input_models.py",
    "tests/unit/jobs/test_job_normalisation.py",
    ...
    "tests/unit/preflight/test_blacklist.py",
    "tests/unit/preflight/test_duplicate_detection.py",
    "tests/unit/preflight/test_prompt_injection.py",
    "tests/unit/preflight/test_preflight_service.py",
    "app/preflight/persistence.py",
    "tests/unit/preflight/test_preflight_persistence.py",
    "app/pipeline/__init__.py",
    "app/pipeline/intake.py",
    "app/pipeline/state.py",
    "app/pipeline/job_extraction.py",
    "app/pipeline/extraction_persistence.py",
    "tests/unit/pipeline/test_application_intake.py",
    "app/llm/__init__.py",
    "app/llm/errors.py",
    "app/llm/schemas.py",
    ...
    "tests/unit/llm/test_llm_schemas.py",
    "tests/unit/llm/test_fake_llm_client.py",
    "tests/unit/pipeline/test_pipeline_state.py",
    "tests/unit/pipeline/test_job_extraction_step.py",
    "tests/unit/llm/test_openai_client_contract.py",
    "tests/unit/pipeline/test_extraction_persistence.py",
    "tests/unit/llm/test_tailoring_schemas.py",
    "tests/unit/llm/test_fake_tailor.py",
    "tests/unit/cv/test_cv_diff.py",
    "tests/unit/pipeline/test_cv_tailoring_step.py",
    ...
    "tests/integration/routes/test_artifact_download_routes.py",
    "tests/integration/pipeline/test_local_pipeline_routes.py",
    "tests/smoke/test_release_smoke.py",
    "tests/unit/exporters/test_markdown_exporter.py",
    "tests/unit/exporters/test_html_exporter.py",
    "tests/unit/exporters/test_export_markdown_html.py",
    "tests/unit/exporters/test_pdf_exporter.py",
    "tests/unit/exporters/test_docx_exporter.py",
    "tests/unit/exporters/test_export_pdf_docx.py",
    "tests/unit/cv/test_cv_markdown_loader.py",
    "tests/unit/cv/test_cv_section_parser.py",
    "tests/unit/cv/test_fact_bank.py",
    "tests/unit/cv/test_cv_selector.py",
    "tests/unit/artifacts/test_artifact_naming.py",
    "tests/unit/artifacts/test_artifact_paths.py",
    "tests/unit/artifacts/test_artifact_writer.py",
    "tests/unit/reports/test_report_models.py",
    "tests/unit/reports/test_evidence_matrix.py",
    "tests/unit/reports/test_match_report.py",

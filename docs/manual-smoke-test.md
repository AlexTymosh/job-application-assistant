...
11. Confirm PDF/DOCX show email, LinkedIn, GitHub, Website, and reference LinkedIn link text/clickable links where supported.
...
16. Confirm Dashboard activity bars are flat muted blue, with 10/20/30-day switching, dates, counts, and hover titles.
17. Confirm no user-facing screen uses old evidence/fact-checking language.

...
2. Add AI-safe source material to the Master CV.
...
Master CV is not a full resume builder clone. It captures only source material that can be used by AI tailoring:

...
- Confirm the **Run local fake pipeline** action creates extracted-job, Evidence Matrix, CV Match Report, Markdown, HTML, PDF, and DOCX artefacts without requiring `OPENAI_API_KEY`.

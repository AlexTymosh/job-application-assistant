...
def build_tailored_cv_pdf_relative_path(*, application_id: UUID) -> str:
    return f"{APPLICATIONS_ARTEFACT_ROOT}/{application_id}/{TAILORED_CV_PDF_FILENAME}"
...
def build_tailored_cv_docx_relative_path(*, application_id: UUID) -> str:
    return f"{APPLICATIONS_ARTEFACT_ROOT}/{application_id}/{TAILORED_CV_DOCX_FILENAME}"
